...
#VALUES ARE OUTDATED SEE STRUCTURAL SIZING FILE
#constants
...
print(tail_sizing(AR_wing,b_wing,S_wing,tail_arm,c_wing,tail_taper_ratio))

# def tail_control_surface_size():
#     tail,area,tail_span=tail_sizing(AR_wing,b_wing,S_wing,tail_arm,c_wing,tail_taper_ratio)
#     rudder_chord=
#     rudder_span
#     elevator_chord
#     elevator_span
#     return rudder_chord,rudder_span,elevator_chord,elevator_span